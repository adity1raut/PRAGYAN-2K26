  ...
  const stats = [
    {
      ...
      icon: <Award className="w-6 h-6 sm:w-8 sm:h-8 text-cyan-400" />
    },
    {
      id: 2,
      number: "10K+",
    ...
    },
    {
      ...
      icon: <Heart className="w-6 h-6 sm:w-8 sm:h-8 text-pink-400" />
    },
    {
      id: 4,
      number: "5+",
      label: "Years of Excellence",
      icon: <Target className="w-6 h-6 sm:w-8 sm:h-8 text-yellow-400" />
    }
  ]

  const values = [
    {
      icon: <Heart className="w-6 h-6 sm:w-8 sm:h-8 text-cyan-400" />,
      title: "Passion",
    ...
    {
      icon: <Award className="w-6 h-6 sm:w-8 sm:h-8 text-pink-400" />,
      title: "Excellence",
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex flex-col relative overflow-x-hidden">
      ...
      <main className="flex-grow relative z-10">
        ...
        <section className="py-8 sm:py-12 md:py-16 px-4 relative z-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black tracking-wider bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent uppercase mb-4 sm:mb-6">
                Our Mission
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  {/* Card */}
                  <div className="relative bg-gradient-to-br from-gray-900/95 to-gray-800/95 backdrop-blur-xl border-2 border-cyan-500/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center transition-all duration-700 hover:border-cyan-500/60 hover:shadow-xl hover:shadow-cyan-500/30 hover:scale-105">
                    ...
                    <h3 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent mb-2">
                      {stat.number}
                    </h3>
        ...
        <section className="py-8 sm:py-12 md:py-16 px-4 relative z-10">
          <div className="max-w-7xl mx-auto">
            <div className="relative bg-gradient-to-br from-gray-900/95 to-gray-800/95 backdrop-blur-xl border-2 border-cyan-500/20 rounded-xl sm:rounded-2xl p-6 sm:p-8 overflow-hidden hover:border-cyan-500/60 transition-all duration-700">
              <h2 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent mb-4 sm:mb-6 text-center">
                Our Vision
              </h2>
        ...
        <section className="py-8 sm:py-12 md:py-16 px-4 relative z-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black tracking-wider bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent uppercase mb-4">
                Our Values
              </h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
              {values.map((value, index) => (
                <div key={index} className="relative group">
                  ...
                  {/* Card */}
                  <div className="relative bg-gradient-to-br from-gray-900/95 to-gray-800/95 backdrop-blur-xl border-2 border-cyan-500/20 rounded-xl sm:rounded-2xl p-5 sm:p-6 text-center transition-all duration-700 hover:border-cyan-500/60 hover:shadow-xl hover:shadow-cyan-500/30 hover:scale-105">
