...
function SpecialEvent() {
  ...
  const galleryImages = [
    { src: "/Junior_Scientist/Junior_Scientist_6.jpeg" },
    { src: "/Junior_Scientist/Junior_Scientist_5.jpeg" },
    { src: "/Junior_Scientist/Junior_Scientist_1.jpeg" },
    { src: "/Junior_Scientist/Junior_Scientist_2.jpeg" },
    { src: "/Junior_Scientist/Junior_Scientist_3.jpeg" },
    { src: "/Junior_Scientist/Junior_Scientist_4.jpeg" },
  ];
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col relative overflow-x-hidden">
      ...
      <main className="flex-grow relative overflow-hidden z-10">
        ...
        {/* Event Dates Section - Small Screens Only */}
