  ...
  return (
    <>
      <nav className="xl:hidden relative z-50">
        ...
        <div
          className={`fixed top-16 right-4 z-[60] w-72 transition-all duration-500 ease-out ${
            isMenuOpen
            ...
            <div className="max-h-[70vh] overflow-y-auto custom-scrollbar py-3 px-3">
              {menuItems.map((item, index) => (
                ...
                >
                  ...
                  <svg
                    className="w-4 h-4 inline-block ml-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
